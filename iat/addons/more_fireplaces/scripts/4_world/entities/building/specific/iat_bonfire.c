class IAT_Bonfire extends BuildingSuper
{
	...
	protected IAT_BonfireLight		m_Light;
	...
	override void EEInit()
	{
		...
		if (!m_Light)
		{
			m_Light = IAT_BonfireLight.Cast(ScriptedLightBase.CreateLight(IAT_BonfireLight, Vector(0,0,0), 1));
