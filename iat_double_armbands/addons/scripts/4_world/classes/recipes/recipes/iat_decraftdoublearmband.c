class IAT_DeCraftDoubleArmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Split Into Single Armbands";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"IAT_DoubleArmband_ColorBase");//you can insert multiple ingredients this way
