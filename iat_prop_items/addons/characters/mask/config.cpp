...
class CfgVehicles
{
    ...
    class IAT_ReaverMask_Colorbase : Clothing
    {
        scope = 0;
        displayName = "Reaver Mask";
        descriptionShort = "A mask with holes drilled through the metal.";
        model = "iat_prop_items\characters\mask\iat_reavermask_g.p3d";
        inventorySlot[] = { "Mask" };
        itemInfo[] = { "Clothing", "Mask" };
        weight = 700;
        itemSize[] = { 2, 2 };
        ...
        repairCosts[] = { 30, 25 };
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_prop_items\characters\mask\data\iat_reavermask_co.paa" };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1, {"iat_prop_items\characters\mask\data\iat_reavermask.rvmat"}},
                        {0.7, {"iat_prop_items\characters\mask\data\iat_reavermask.rvmat"}},
                        {0.5, {"iat_prop_items\characters\mask\data\iat_reavermask_damage.rvmat"}},
                        {0.3, {"iat_prop_items\characters\mask\data\iat_reavermask_damage.rvmat"}},
                        {0, {"iat_prop_items\characters\mask\data\iat_reavermask_destruct.rvmat"}}
                    };
                };
            };
        };
        class ClothingTypes
        {
            male = "iat_prop_items\characters\mask\iat_reavermask_m.p3d";
            female = "iat_prop_items\characters\mask\iat_reavermask_m.p3d";
        };
        class AnimEvents
        {
            class SoundWeapon
    ...
    class IAT_ReaverMask_Basic : IAT_ReaverMask_Colorbase
    {
        scope = 2;
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_prop_items\characters\mask\data\iat_reavermask_co.paa" };
    };
    class IAT_ReaverMask_eternallyfree : IAT_ReaverMask_Colorbase
    {
        scope = 2;
        TradeClassName = "MetalPlate";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_prop_items\characters\mask\data\iat_reavermask_eternalfyree_co.paa" };
    };
};