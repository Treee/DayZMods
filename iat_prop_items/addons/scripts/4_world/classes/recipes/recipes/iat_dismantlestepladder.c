class IAT_DismantleLadder extends RecipeBase
{
	override void Init()
	{
		m_Name = "Pack Ladder";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"IAT_Ladder_Opened_ColorBase");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"LugWrench");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("IAT_Ladder_Closed_");//add results here
