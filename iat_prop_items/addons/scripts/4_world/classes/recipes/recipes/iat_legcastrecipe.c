class IAT_CraftLegCast extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Leg Cast";
		...
		//result1
		AddResult("IAT_LegCast_Basic");//add results here
...
class IAT_CraftLegCast_Permanent extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Leg Cast - Permanent";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("IAT_LegCast_Permanent");//add results here
