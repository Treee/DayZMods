...
class CfgVehicles
{
    ...
    class IAT_MorgulBlade_Colorbase : Inventory_Base
    {
        ...
        descriptionShort = "A well forged knife that looks like a popular blade.";
        model = "iat_melee_weapons\blade\iat_morgulblade.p3d";
        debug_ItemCategory = 2;
        inventorySlot[] = { "Knife" };
        repairableWithKits[] = { 4 };
        repairCosts[] = { 10 };
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1, {"iat_melee_weapons\blade\data\iat_morgulblade.rvmat"}},
                        {0.7, {"iat_melee_weapons\blade\data\iat_morgulblade.rvmat"}},
                        {0.5, {"iat_melee_weapons\blade\data\iat_morgulblade_damage.rvmat"}},
                        {0.3, {"iat_melee_weapons\blade\data\iat_morgulblade_damage.rvmat"}},
                        {0, {"iat_melee_weapons\blade\data\iat_morgulblade_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_MorgulBlade_comradeg : IAT_MorgulBlade_Colorbase
    {
        ...
        TradeClassName = "HuntingKnife";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_melee_weapons\blade\data\iat_morgulblade_comradeg_co.paa" };
    };
    ...
    class IAT_KatanaFlower_ColorBase : Inventory_Base
    {
        scope = 0;
        displayName = "Flower Katana";
        descriptionShort = "A sharp blade with immense striking power.";
        model = "iat_melee_weapons\blade\iat_katanaflowerblade.p3d";
        debug_ItemCategory = 2;
        repairableWithKits[] = { 4 };
        repairCosts[] = { 25 };
        inventorySlot[] = { "IAT_Katana" };
        ...
        openItemSpillRange[] = { 40, 60 };
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_melee_weapons\blade\data\iat_flowerkatana_co.paa" };
        class InventorySlotsOffsets
        {
            class Melee
            {
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                ...
                {
                    hitpoints = 200;
                    healthLevels[] = { {1, {"iat_melee_weapons\blade\data\iat_flowerkatana.rvmat"}}, {0.7, {"iat_melee_weapons\blade\data\iat_flowerkatana.rvmat"}}, {0.5, {"iat_melee_weapons\blade\data\iat_flowerkatana_damage.rvmat"}}, {0.3, {"iat_melee_weapons\blade\data\iat_flowerkatana_damage.rvmat"}}, {0, {"iat_melee_weapons\blade\data\iat_flowerkatana_destruct.rvmat"}} };
                };
            };
        };
        isMeleeWeapon = 1;
    ...
    class IAT_KatanaFlower_Basic : IAT_KatanaFlower_ColorBase
    {
        scope = 2;
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "iat_melee_weapons\blade\data\iat_flowerkatana_co.paa" };
    };
    class IAT_KatanaFlower_zero_hurts : IAT_KatanaFlower_ColorBase
    {
        scope = 2;
        TradeClassName = "Sword";
        hiddenSelections[] = { "zbytek" };
