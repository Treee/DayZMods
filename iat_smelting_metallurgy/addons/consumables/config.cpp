...
{
	/*
	* The assumption here is all the below changes are
	* additive so I don't really need the required addon.
	* This is a mindful change so I can include the example
	* within the mod for adding you own acclerants and ores
	*/
	class IAT_Smelting_Metallurgy_Consumables
	{
		requiredAddons[] = { "DZ_Data", "DZ_Scripts", "IAT_Mining_Consumables" };
	};
};
class CfgVehicles
{
